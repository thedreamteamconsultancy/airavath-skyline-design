...
const features = [
  { icon: Crown, title: "Premium Experience", description: "Sky Ports are designed for executive and VIP travelers. Lounges, concierge services, and private boarding." },
  ...
  { icon: Landmark, title: "Prime Locations", description: "Positioned on landmark skyscrapers in business districts, financial centers, and hotel towers." },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="section-padding" style={{ background: "linear-gradient(180deg, hsl(0 0% 2%) 0%, hsl(0 0% 0%) 100%)" }}>
        <div className="container-airavath text-center">
          <ScrollReveal>
            <h2 className="font-heading text-[28px] md:text-[36px] font-semibold text-foreground tracking-futuristic mb-6">Explore the Full Network</h2>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link to="/hub-network" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-card border border-border text-foreground font-body hover:border-primary/30 transition-all">Network <ChevronRight size={16} /></Link>
            </div>
          </ScrollReveal>
        </div>
      </section>
