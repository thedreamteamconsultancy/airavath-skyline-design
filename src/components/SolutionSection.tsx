...
const MobilePillarCard = ({ pillar }: { pillar: typeof pillars[0] }) => (
...
const SolutionSection = () => {
  ...
  const mobileCards = pillars.map((pillar) => ({
    content: <MobilePillarCard pillar={pillar} />,
  }));
  ...
  return (
    ...
    >
      ...
      <div className="container-airavath relative z-10">
        ...
        {/* Highlight Strip */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-6x" style={{ marginTop: isMobile ? "48px" : "120px" }}>
