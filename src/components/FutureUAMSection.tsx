...
const aircraftCards = [
  ...
  },
  {
    ...
    description:
      "Off-demand passenger mobility services operating across city HUB, reducing travel time from hours to minutes.",
    image: cardUam,
...
const validationBlocks = [
  ...
  },
  {
    ...
    text: "Breakthroughs in fleet management, navigation, and booking by using platform are enabling scalable aerial mobility operations.",
  },
  {
    icon: Building2,
    title: "Infrastructure Development",
    text: "Cities are beginning to develop vertiports and mobility points to support aerial transportation networks.",
  },
];
