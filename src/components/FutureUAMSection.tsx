...
const FutureUAMSection = () => {
  return (
    <section className="relative overflow-hidden atmosphere-blue" style={{ paddingTop: "80px", paddingBottom: "80px", background: "linear-gradient(180deg, hsl(var(--surface-1)) 0%, hsl(var(--surface-0)) 100%)" }}>
      {/* Background effects */}
