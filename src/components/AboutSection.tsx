...
const missionBlocks = [
  {
    ...
    title: "Our Mission",
    description:
      "To operate fast, efficient, and sustainable aerial mobility services that connect cities through a network of mobility.",
  },
  {
    icon: Network,
    title: "Operational Excellence",
    description:
      "Managing end-to-end urban air mobility operations including aircraft fleet management, vertiport networks, and on-demand booking by using platform.",
  },
  {
    icon: Leaf,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-16 lg:gap-x-[80px]">
          <div className="lg:col-span-6">
            {[
              ...
              "By operating electric aircraft fleets, vertiport networks, and intelligent mobility by using platform, AIRAVATH enables fast, safe, and sustainable transportation for passengers and cargo.",
