...
const TourismSection = () => (
  <div id="tourism-mobility" className="relative">
    <ComparisonBlock
      ...
      solutionAlt="eVTOL aircraft flying above scenic city landmarks, religious temples, with passengers"
      solutionCaption="Aerial City Tours"
    />
    <div className="flex justify-center -mt-8 md:-mt-16 mb-10 md:mb-16 px-4 relative z-10">
      <Link
        to="/tourism-mobility"
        state={{ returnTo: "/#tourism-mobility", returnScrollY: window.scrollY, restoreBookmark: true }}
